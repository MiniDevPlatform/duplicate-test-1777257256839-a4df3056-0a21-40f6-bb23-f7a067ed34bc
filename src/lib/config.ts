 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * Project: duplicate-test-1777257256839
 * Type: game
 * Category: puzzle
 * 
...
export const PROJECT = {
  name: 'duplicate-test-1777257256839',
  slug: 'duplicate-test-1777257256839',
  description: 'Created with MiniDev ONE Template',
  author: 'MiniDev User',
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://duplicate-test-1777257256839.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/duplicate-test-1777257256839',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'duplicate-test-1777257256839_progress' },
